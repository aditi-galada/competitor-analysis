//Read txt files 
function readFile() {
    jQuery.get('T-ShirtPrice.txt',function(txt){
...
function readFile1() {
    jQuery.get('T-ShirtCategory.txt',function(txt){
...
function readFile2() {
    jQuery.get('T-ShirtTechnique.txt',function(txt){
...
var scene = new ScrollMagic.Scene({triggerElement:"#panel4 .pricepie8", triggerHook:.0})  
.setTween(tween)
.addTo(controller);
